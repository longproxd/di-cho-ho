...
export default class StoreDetail extends Component {
    ...
    componentDidMount() {
        axios.get('https://localhost:7003/api/doitac')
            .then(res => {
                const DoiTac = res.data;
                this.setState({ DoiTac });
            })
